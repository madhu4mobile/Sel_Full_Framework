...
public class TestCasesToRegisterATestUser {
    ...
    private String myUser = "autotestuser1";
    private String myUserEmail = "autotestuser1@askomdch.com";
    private String myUserPassword = "auto123";

    private String registrationErrorElementPath = "//div[@id='content']//li[1]";
    private String registrationSuccessElement_Document_path = "//a[contains(text(),'Dashboard')]";

    private String registerUsernameElementPath = "//input[@id='reg_username']";
    private String registerEmailaddressPath = "//input[@id='reg_email']";

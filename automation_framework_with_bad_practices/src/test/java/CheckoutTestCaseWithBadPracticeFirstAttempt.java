...
public class CheckoutTestCaseWithBadPracticeFirstAttempt {
    ...
    */
    ...
    public CheckoutTestCaseWithBadPracticeFirstAttempt() throws NoSuchFieldException {
    }
    ...
    public void guestCheckoutUsingDirectBankTransfer() throws InterruptedException {
      ...
      */
        ...
        int order_number_value = Integer.parseInt(driver.findElement(By.cssSelector("li[class='woocommerce-order-overview__order order'] strong")).getText());
        Assert.assertTrue (order_number_value > 0);
    ...
    @Test
    public void loginAsUserAndCheckoutUsingDirectBankTransfer() {
